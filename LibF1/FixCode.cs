    ...
    public class ScriptEngine
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                DeleteFile("JLinkSettings.ini");
                DeleteFile("JLinkLog.txt");
                DeleteFile("*.dep");
                DeleteFile("*.bak");
                DeleteFile("*." + Environment.UserName);
        ...
        static void DeleteFile(String ext)
        {
            foreach (var item in Directory.GetFiles(".".GetFullPath(), ext, SearchOption.AllDirectories))
            {
                try
                {
                    File.Delete(item);
