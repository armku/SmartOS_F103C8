...
/* Delay definition */
// GD32由于自有flash的0访问时序，同STM32在Flash的Erase和Program上存在差别，GD32的Erase和Program时间比STM32的稍微长些,建议对Erase和Program时间进行修改。
#ifdef GD32
...
#ifdef GD32
	// 由于GD的Flash是自己的专利技术，SM的Flash是第三方提供的，所以GD的Flash和SM的Flash有些许差异。GD的擦除时间更长一点
